...
import sales.utils.Requests_GetResponse;
...
public class ProductRequest extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equals("CreateProductRequest"))
        {
            ...
            Type pRequestListType = new TypeToken<ArrayList<sales.models.ProductRequestDetail>>(){}.getType();
            ArrayList<sales.models.ProductRequestDetail> pRequestDetails = new Gson().fromJson(objs, pRequestListType);       
            response.setContentType("application/json");
            // Get the printwriter object from response to write the required json object to the output stream      
            PrintWriter out = response.getWriter();
            // Assuming your json object is **jsonObject**, perform the following, it will return your json object  
            sales.models.ProductRequest ProductRequestobj = new sales.models.ProductRequest(0,Integer.parseInt(sourcebranch),UserBranch,"","Pending",0,User);
        ...
        if(action.equals("GetAllProductRequests"))
        {
            ...
            PrintWriter out = response.getWriter();
            // Assuming your json object is **jsonObject**, perform the following, it will return your json object  
            sales.models.ProductRequest ProductRequestobj =new sales.models.ProductRequest();
