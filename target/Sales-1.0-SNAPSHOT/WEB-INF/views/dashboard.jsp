...
<aside id="menu">
    <div id="navigation">
        <div class="profile-picture">
            <a href="index.html">
                <img src="${pageContext.request.contextPath}/images/market.png" style="width: 100px;" class="img-circle m-b" alt="logo">
            </a>
            ...
            <% if (request.getSession().getAttribute("Type").toString().equals("Administrator") && request.getSession().getAttribute("BType").toString().equals("Head") ) { %>
                     <ul class="nav" id="side-menu">
                        <li>
                             ...
                             <li>
                                 <a href="${pageContext.request.contextPath}/ProductRegister.sales"> <span class="nav-label">Logs</span> </a>
                             </li>
            ...
            <% } else if(request.getSession().getAttribute("Type").toString().equals("Administrator") && !request.getSession().getAttribute("BType").toString().equals("Head") ) { %>
                        ...
                        <li>
                             ...
                             <li>
                                 <a href="${pageContext.request.contextPath}/ProductDetails.sales"> <span class="nav-label">Logs</span> </a>
                             </li>
                            
                             </ul>
            <% }  else if(request.getSession().getAttribute("Type").toString().contains("Staff") && request.getSession().getAttribute("BType").toString().equals("Head") ) { %>
                            <ul class="nav" id="side-menu">                
                            <li>
                                <a href="${pageContext.request.contextPath}/BranchServlet.sales?branch=${sessionScope.Branch}"> <span class="nav-label">${sessionScope.Type}</span> </a>
                            </li>
            ...
            <% } else { %>
                            ...
                            <ul class="nav" id="side-menu">                
                            <li>
                                <a href="${pageContext.request.contextPath}/Profile.sales">My Profile <span class="nav-label">${sessionScope.Type}</span> </a>
                            </li>
                             <li>
                                 <a href="${pageContext.request.contextPath}/UserServlet.sales"> <span class="nav-label">My Tickets</span> </a>
                             </li>
                            </ul>
            <% }%>
