    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center m-b-md">
                ...
                <small>This is the best app ever! PHOENIX AIRLINE</small>
            </div>
            <div class="hpanel">
                <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/Register" method="POST" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <span class="help-block small">Your </span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="username">Username</label>
                                <input type="text" placeholder="example@gmail.com" title="Please enter you username" required="" value="" name="uname" id="username" class="form-control">
                                <span class="help-block small">User type Required</span>
                            </div>
                            
                            <div class="form-group">
                                <label class="control-label" for="username">Full Name</label>
                                <input type="text" placeholder="Sample Name" title="" required="" value="" name="name" id="" class="form-control">
                                <span class="help-block small">Full Name</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="username">NIC</label>
                                <input type="text" placeholder="********" title="" required="" value="" name="nic" id="" class="form-control">
                                <span class="help-block small">Your unique nic no</span>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="username">Email</label>
                                <input type="email" placeholder="example@gmail.com" title="" required="" value="" name="email" id="" class="form-control">
                                <span class="help-block small">Your unique Email</span>
                            </div>
                            
                            <div class="form-group">
                                <label class="control-label" for="username">Contact</label>
                                <input type="text" placeholder="07*******" title="" required="" value="" name="contact" id="" class="form-control">
                                <span class="help-block small">Your unique contact no</span>
                            </div>
                            <div class="form-group">
